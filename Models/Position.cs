...
public class Position
{
    ...
    {
        char columnChar = (char)('A' + this.X); // Convertir l'indice de colonne en lettre (0 devient 'A', 1 devient 'B', etc.)
        int rowNumber = 8 - this.Y; // Convertir l'indice de ligne en numéro de ligne (0 devient 8, 1 devient 7, etc.)
